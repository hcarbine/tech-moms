...
document.getElementById("btnSix").onclick = function() {
	...
	if (height > 50){
	alert("You may ride Wicked")
	}
	else if(height >46){
		alert("You may ride wicked, but you must use a booster seat.")
	}
	else {
		alert("You may NOT ride Wicked")
	}
};
...
var credits = parseFloat(prompt("Enter your earned credits: "))
	if(gpa >= 2.7 && credits >= 63){
		alert("You may graduate!")
	}
	if(gpa >= 2.7 && credits < 63){
		alert("Credit Deficient")
	}
	if(gpa < 2.7 && credits >=63){
		alert("Low GPA")
	}
	if(gpa <2.7 && credits <63){
		alert("You CANNOT graduate!")
	}
};
...
document.getElementById("btnTwelve").onclick = function() {
	...
	while(num!=1&&num !=2&&num!=3&&num!=4&&num!=5&&num!=6&&num!=7&&num!=8&&num!=9&&num!=10) {
		num = prompt("You didn't follow instructions. Please enter a number between 1 and 10");	
	}
	alert("Great job! You followed instructions");*/
	var num=prompt("Enter a number between 1 and 10");
	while(num<1||num>10){
		num=prompt("You didn't follow directions. Enter a number between 1 and 10")
	}
	alert("Great job! You followed directions.")
};
...
/*Write a script to allow the user to enter a word, 
it will show each of the letters in reverse order*/
var word = prompt("Enter a word");
...
/*Write a script to allow the user to enter a number.  
The script will then report back all the even numbers up to that number*/
...
document.getElementById("btnTwenty").onclick = function(){
	/*Write a script to allow the user to enter a sentence: 
	the program will report the number of vowels in that sentence */
var sentence=prompt("Enter a sentence");
var vowel = 0
for(var i = 0; i < sentence.length; i++){
	var letter = sentence.charAt(i);
...
alert("There are " + vowel + " vowels in " + sentence);
